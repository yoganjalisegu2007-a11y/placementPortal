...
public class AppliedServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.println(".application-card:hover {");
        out.println("box-shadow:0 5px 18px rgba(0,0,0,.08);");
        ...
        out.println("<p>");
        out.println("Track your placement applications and their current status.");
        out.println("</p>");
        ...
        try {
            ...
            try (
                ...
                try (ResultSet rs = ps.executeQuery()) {
                    ...
                    /* =================================================
                       FIRST PASS FOR APPLICATION DATA
                       ================================================= */
                    ...
                    while (rs.next()) {
                        ...
                        else if (statusUpper.contains("INTERVIEW")) {
                    ...
                    out.println("Application History");
    ...
    /* =============================================================
       HTML ESCAPE METHOD
       Prevents unsafe database text from being interpreted as HTML.
       ============================================================= */
